...
export function BottomNavBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-20 w-full border-t bg-background/95 backdrop-blur-sm md:hidden pb-[env(safe-area-inset-bottom)]" suppressHydrationWarning>
